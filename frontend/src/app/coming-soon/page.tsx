    ...
    <main className="min-h-screen bg-[#0b0c10] text-white">
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col items-center justify-center px-6 py-16">
          <div className="mb-8 flex items-center gap-3 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.35em] text-white/70">
            RYVEN
          </div>

          <h1 className="text-center text-4xl font-semibold tracking-tight sm:text-5xl lg:text-6xl">
          ...
          <div className="mt-10 w-full max-w-md rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur">
            <p className="text-sm font-semibold text-white">Access the private preview</p>
            <p className="mt-1 text-sm text-white/60">
              Enter the password to view the full website.
            </p>
